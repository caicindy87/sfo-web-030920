...
![gif](./images/refactoring-components.gif)
...
## 2 Problems Redux attempts to solve

- Problem 1: Needless passing of props - Redux reduces the needless passing of props (by putting state in one place)
  ![without-redux](./images/without-redux.png)
  ![redux](./images/redux.png)

* Problem 2: State is hard to predict (ever changing) - The reducer decides HOW state can be changed, based on a set of rules
